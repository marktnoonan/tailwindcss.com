...
This should be done if the nature of the contents truly represent a list so that VoiceOver users will have that information announced correctly to them.
